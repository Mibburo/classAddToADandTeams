...
public class PathBasedKeycloakConfigResolver implements KeycloakConfigResolver {
    ...
    public KeycloakDeployment resolve(OIDCHttpFacade.Request request) {
        ...
        if (    request.getRelativePath().equals("/")
                ...
                || request.getRelativePath().contains("/sendEmail")
            ...
            return KeycloakDeploymentBuilder.build(getClass().getResourceAsStream("/ssi.json"));
        }



        if (request.getHeader("referer") != null && !(path.contains("ssi") && path.contains("eidas")
                 && path.contains("admin")
